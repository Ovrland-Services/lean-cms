module LeanCms
  module Authorization
    ...
    def require_cms_access
      unless Current.user&.has_any_cms_permission?
    ...
    def require_settings_access
      unless Current.user&.can_access_settings?
    ...
    def can_edit?(record)
      return true if Current.user&.is_super_admin?
      return true if record.respond_to?(:author) && record.author == Current.user
      false
    end
